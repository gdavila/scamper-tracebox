...
#define TRACEBOX_RETX_DEFAULT           1
#define TRACEBOX_TIMEOUT_DEFAULT        1000
#define TRACEBOX_TIMEOUT_LONG           3000
#define TRACEBOX_SINGLE_HOP_MAX_REPLAYS 1
#define TRACEBOX_TOTAL_MAX_REPLAYS   	2
#define TRACEBOX_MAX_HOPS               64
#define TRACEBOX_DEFAULT_MSS		    1460
#define TRACEBOX_DEFAULT_WSCALE		    14
#define TRACEBOX_DEFAULT_TCPWIN         0
