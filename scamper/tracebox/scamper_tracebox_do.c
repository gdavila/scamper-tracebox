...
static const scamper_option_in_t opts[] = {
  ...
  {'s', "sport", TRACEBOX_OPT_SPORT,       SCAMPER_OPTION_TYPE_NUM},
...
{
  return "tracebox [-6urt] [-p probe] [-r raw-packet] [-d dport] [-s sport] [--stateful] [--proxy] [--proxy-secondary-dport]";
}
...
static int tracebox_app_default(scamper_tracebox_t *tracebox, 
   ...
   if(tracebox->sport == 0) tracebox->sport = scamper_sport_default();
